...
- **AI skill scoring** — GitHub profiles are scanned and analysed to generate an automated skill score for each student
...
- **PDF portfolio export** — students can export their profile and completed work as a downloadable PDF
- **Email notifications** — powered by Nodemailer for application status updates
- **Session-based authentication** — secure login with bcrypt password hashing and express-session
...
| AI / Analysis | Python | GitHub repo scanner for automated skill scoring |
...
| PDF export | Puppeteer + jsPDF | Student portfolio PDF generation |
